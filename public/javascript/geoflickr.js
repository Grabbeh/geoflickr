...
function processFlickrData(photos) {
    ...
    if (photos.length === 0) {
        ...
        for (var i = 0; i < photos.length; i++) {
            ...
            var flickrurl = "http://flickr.com/photo.gne?=" + photoId + "/"
            $('#photos').append("<span>" + "<a href=" + mainurl + ">" + "<img src=" + thumbnail + "></a></span>" + "<div class=/"hiddenflickrlink/">" + "<a href=" + flickrurl + ">" + "Photo on Flickr</a></div>");
